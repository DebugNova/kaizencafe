...
const items: MenuItem[] = [
  {
    ...
    note: "rich, dark, strawberries on top",
    img: "/images/cheesecake-slice.jpg",
    alt: "A slice of rich chocolate cheesecake topped with a fresh strawberry.",
    revealed: true,
    script: "taste us!",
    tag: "Signature",
  },
  {
    name: "House Espresso",
    note: "small-batch, slow-pulled",
    img: "/images/espresso-cake.jpg",
    alt: "A glass of espresso beside a slice of cake and fresh flowers.",
    revealed: true,
    script: "feel the warmth",
    tag: "House Special",
  },
  {
    name: "Mango Tarts",
    note: "fresh mango, basil, berries",
    img: "/images/mango-tarts.jpg",
    alt: "Mango tarts topped with fresh strawberries and basil.",
    revealed: true,
    script: "summer's here",
    tag: "Seasonal",
  },
  {
    name: "The House Loaf",
