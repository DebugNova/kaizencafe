...
export function AnnouncementBar() {
  ...
  return (
    <div
      ...
      className="w-full overflow-hidden bg-primary text-primary-foreground text-[11px] sm:text-xs tracking-[0.3em] uppercase border-b border-primary/40 marquee-pause"
    >
