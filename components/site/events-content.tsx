            ...
            {submitted ? (
              ...
              >
                ...
                <input
                  ...
                  aria-describedby={error ? "events-notify-error" : undefined}
                  className="min-w-0 rounded-full bg-background/10 border border-background/20 px-5 py-3 text-sm text-background placeholder:text-background/40 focus:outline-none focus:border-primary transition-colors min-h-[44px] disabled:opacity-60"
                />
                <motion.button
                  type="submit"
                  disabled={pending}
                ...
                >
                  {pending ? "Sending…" : "Add me to the list"}
                </motion.button>
              </motion.form>
            )}
          </AnimatePresence>
