...
export function Testimonials() {
  return (
    <section className="relative bg-secondary/40 py-20 sm:py-28 border-y border-border/60 overflow-hidden">
          ...
          {quotes.map((q) => (
            <Item key={q.name}>
              <motion.figure
                ...
                className="relative rounded-sm bg-card border border-border/60 p-7 shadow-[0_10px_30px_-20px_oklch(0.22_0.025_40/0.4)]"
              >
                <Quote
